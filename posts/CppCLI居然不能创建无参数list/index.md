...
![1571120993580](./images/1571120993580.png)

![1571121036671](./images/1571121036671.png)

然而c++/cli是.NET兼容语言，语法自然是支持list或者foreach的使用的。所以事实上这里的语法完全没有任何问题，而且是可以通过编译的，就如同下图。

![1571121163700](./images/1571121163700.png)
...
![1571121596884](./images/1571121596884.png)
...
![1571123394958](./images/1571123394958.png)
