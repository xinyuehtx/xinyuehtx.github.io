...
![1551953146664](./images/1551953146664.png)

不要被这些表象给骗了，哪有说的这么简单。

我们看一下MessageBox 的原始签名
![1551953470968](./images/1551953470968.png)
...
![1551955361132](./images/1551955361132.png)
...
![1552045351630](./images/1552045351630.png)
...
![1552045557496](./images/1552045557496.png)

第2,3个参数都是`LPCTSTR`

`LPCTSTR` = L‌ong P‌ointer to a C‌onst T‌CHAR String 所以这是一个字符串，我们此处使用`string`

![1552045841804](./images/1552045841804.png)
...
![1552047349012](./images/1552047349012.png)

接着是签名和参数，`LPGUID`我们没有提过，看解释这边是指向GUID的一个指针，所以我们使用`Guid`这个类型

![1552047409722](./images/1552047409722.png)
...
![1552047824522](./images/1552047824522.png)
