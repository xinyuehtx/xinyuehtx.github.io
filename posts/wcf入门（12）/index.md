...
![1548941800449](./images/1548941800449.png)

服务实现上我们通过`Task.Delay`模拟异步操作

![1548941872550](./images/1548941872550.png)

客户端实现上注意需要添加`await`

![1548941941232](./images/1548941941232.png)

在使用时输出返回值

![1548941995445](./images/1548941995445.png)

结果如图所示，我们看到主线程先输出了发送完成，异步线程在完成异步操作后返回输出

![1548942051753](./images/1548942051753.png)
...
![1548942474550](./images/1548942474550.png)

![1548942453147](./images/1548942453147.png)

结果发现在服务端输出收到消息之前，客户端代码就已经返回了。

而不需要等到服务端执行到await

![1548942413100](./images/1548942413100.png)
