---
title: "C++CLI的托管字符串std字符串和c字符串的转换"
date: 2019-11-13
tags:
  - 其他
...
![image-20191113085039110](./images/image-20191113085039110.png)

与此同时，string.h还定义了`string`构造函数从cstring构造std::string

![image-20191113085405293](./images/image-20191113085405293.png)
...
![image-20191113085828560](./images/image-20191113085828560.png)

同样可以使用System::String 的构造函数从char数组构造System::String

![image-20191113090850730](./images/image-20191113090850730.png)

当然你也可以使用`Marshal::StringToHGlobalAnsi`或者`Marshal::StringToHGlobalUni`将其转换为char\*或者wchar_t\*

![image-20191113091620246](./images/image-20191113091620246.png)

# System::String 和std::string

std::string到System::String我没有直接的转换，直接使用cstring做中转

![image-20191113092240396](./images/image-20191113092240396.png)

System::String到std::string或者std::wstring,可以使用marshal_context进行转换

![image-20191113092444134](./images/image-20191113092444134.png)
