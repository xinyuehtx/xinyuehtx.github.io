...
![image-20191112213759299](./images/image-20191112213759299.png)

当我们将其在c#项目中引用时，神奇的事情发生了，这个枚举的枚举值不见了。

![image-20191112213851595](./images/image-20191112213851595.png)

现在我们试着给枚举值做一点改变，加一个class

![image-20191112214202076](./images/image-20191112214202076.png)

枚举又正常了。

![image-20191112214111481](./images/image-20191112214111481.png)
