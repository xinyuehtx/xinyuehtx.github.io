...
![Text with image brush applied to stroke](./images/IC34839.jpeg) 
...
![1530780542113](./images/1530780542113.png)
...
![1530780893236](./images/1530780893236.png)

这样就可以得到对应的`Geometry`了

此外，还可以通过下面这个方法从`Geometry`获得对应的`Path`

![1530781102178](./images/1530781102178.png)

最后的效果如下：

![1530781156403](./images/1530781156403.png)
