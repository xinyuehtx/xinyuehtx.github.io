...
![image-20200322093328904](./images/image-20200322093328904.png)

- 如果从起始点出发，任意两点的路径长度一致，意味着这两点之间仍然需要比赛确定名次。

![image-20200322093745354](./images/image-20200322093745354.png)

所以我们就可以先搭建这样一个节点图。

这里每一个节点的数字代表马的真实排名，当然我们现在只是作为上帝视角知道这个排名。

![image-20200322094442259](./images/image-20200322094442259.png)

我们首先随机分成8组进行比赛，可以获得如下的有向图

为了实现连通，这里增加了一个dumb节点，表示所有节点的起始节点

![image-20200322095048249](./images/image-20200322095048249.png)
...
![image-20200322095850571](./images/image-20200322095850571.png)
...
![image-20200322100709171](./images/image-20200322100709171.png)

所以简化图形得到如下结果

![image-20200322101043795](./images/image-20200322101043795.png)
...
![image-20200322101947667](./images/image-20200322101947667.png)
...
![image-20200322115504545](./images/image-20200322115504545.png)
...
![image-20200322115556985](./images/image-20200322115556985.png)
...
![image-20200322122716505](./images/image-20200322122716505.png)

对节点 5,6,7,9,10,12,13,20进行比赛

![image-20200322123254962](./images/image-20200322123254962.png)
...
![image-20200322124041330](./images/image-20200322124041330.png)

再选择节点4,9,5,10,12,11,20,13

![image-20200322124450417](./images/image-20200322124450417.png)

再选择节点6,7,9,10,11,14,15,22

![image-20200322124758247](./images/image-20200322124758247.png)
