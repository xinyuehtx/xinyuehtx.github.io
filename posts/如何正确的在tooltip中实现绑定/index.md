...
![image-20200108211215813](./images/image-20200108211215813.png)

但是我们看到实际上这里tooltip并没有显示内容

![image-20200108211245071](./images/image-20200108211245071.png)

而如果我们使用了{x:Reference}替换ElementName

![image-20200108211317658](./images/image-20200108211317658.png)

结果就可以直接显示了

![image-20200108211356967](./images/image-20200108211356967.png)
...
![image-20200108220429753](./images/image-20200108220429753.png)

![image-20200108220245526](./images/image-20200108220245526.png)
