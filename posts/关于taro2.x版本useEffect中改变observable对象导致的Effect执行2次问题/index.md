---
title: "关于taro2.x版本useEffect中改变observable对象导致的Effect执行2次问题"
date: 2020-07-15
tags:
  - 前端
...
<!-- broken image: ![image-20200715142534730](./images/image-20200715142534730.png) -->
...
<!-- broken image: ![image-20200715142928066](./images/image-20200715142928066.png) -->
...
<!-- broken image: ![image-20200715143502185](./images/image-20200715143502185.png) -->

为此，在所有待执行的effect函数都被存储在当前组件节点的effects列表中

<!-- broken image: ![image-20200715144854430](./images/image-20200715144854430.png) -->

我们再看看实际执行effect的方法。

可以看到，这里依次调用effect的方法，并且获取cleanup函数，之后再请客effect数组。

<!-- broken image: ![image-20200715145249457](./images/image-20200715145249457.png) -->
...
<!-- broken image: ![image-20200715145750962](./images/image-20200715145750962.png) -->

而此时上一次的effects.forEach方法并没有执行完成，因此组件的effects队列没有清空。

此时再次进入，就导致了effects执行2次的情况。

<!-- broken image: ![image-20200715150310551](./images/image-20200715150310551.png) -->
...
<!-- broken image: ![image-20200715152247277](./images/image-20200715152247277.png) -->
...
<!-- broken image: ![image-20200715152846022](./images/image-20200715152846022.png) -->
...
<!-- broken image: ![image-20200715154310499](./images/image-20200715154310499.png) -->
...
<!-- broken image: ![image-20200715155132385](./images/image-20200715155132385.png) -->
