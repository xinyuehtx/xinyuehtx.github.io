...
![image-20200107160344750](./images/image-20200107160344750.png)

下面是我在电脑上使用的效果。这里完全获取了远程桌面账户的权限，不但可以获取图像，而且可以流畅操作各类windows软件。（从此可以带着mac使用en5上课了）

![image-20200107160529172](./images/image-20200107160529172.png)

![image-20200107160613053](./images/image-20200107160613053.png)

此外他还支持使用RDP文件导入远程桌面配置，因此可以轻松从现有设备中迁移远程桌面配置。

![image-20200107160556037](./images/image-20200107160556037.png)

另外对于在双系统下操作不便的同学来说，可以自主选择你的复制粘贴等快捷键是使用ctrl+c，ctrl+v， 还是command+c，command+v

![image-20200107161026339](./images/image-20200107161026339.png)
...
![image-20200107162151861](./images/image-20200107162151861.png)
