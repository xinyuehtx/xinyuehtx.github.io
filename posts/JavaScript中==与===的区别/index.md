...
![image-20200119191201380](./images/image-20200119191201380.png)
...
![image-20200119191111661](./images/image-20200119191111661.png)

那么如何判断使用==时，类型的转换呢？MDN上面列出了一个详细的类型转换表格，参见如下：

![image-20200119190850464](./images/image-20200119190850464.png)
