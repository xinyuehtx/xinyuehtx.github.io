...
![1550024512455](./images/1550024512455.png)

![1550024530248](./images/1550024530248.png)

![1550025750493](./images/1550025750493.png)

### 创建服务和客户端进程

![1550025474607](./images/1550025474607.png)

在服务端我们创建一个`CustomBinding`将`UnreliableElement`和`TcpTransportBindingElement`传入

![1550025781351](./images/1550025781351.png)

客户端也类似，额外的我们这里连续发送20条消息

![1550025445200](./images/1550025445200.png)

结果可见其中许多消息出现了丢失。

![1550025364375](./images/1550025364375.png)

### 使用可靠会话

现在我们修改示例，在binding中添加一个`ReliableSessionBindingElement`,并且设置`Order`为false

![1550025969517](./images/1550025969517.png)

我们看到20条消息都发送成功，但是其中部分消息的顺序是错误的

![1550025926344](./images/1550025926344.png)
...
![1550026118483](./images/1550026118483.png)
