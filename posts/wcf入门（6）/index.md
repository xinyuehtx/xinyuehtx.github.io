...
![1548592533286](./images/1548592533286.png)

我们看下客户端的调用，依次调用会话启动方法，其余方法，会话终止方法。

![1548592630219](./images/1548592630219.png)
...
![1548592962563](./images/1548592962563.png)

![1548592942459](./images/1548592942459.png)

当然如下所示的尝试在这个通过再次建立会话也是不可以的。

![1548593008154](./images/1548593008154.png)

如果需要重新同服务端通信，则需要再次实例化一个SessionClient

![1548593102210](./images/1548593102210.png)

![1548593083738](./images/1548593083738.png)
