...
1. 我们在jenkins上建立一个工程，这个工程可以做build或者test或者publish
   ...
   ![1535340744971](./images/1535340744971.png)

2. 添加源码管理，对我们项目来说是gitlab

   ![1535341430819](./images/1535341430819.png)

3. 设置触发器，这个是最有用的地方，可以决定我们在什么时机去运行这个jenkins工程

   ![1535342903000](./images/1535342903000.png)

   - merge request触发

     ![1535343239580](./images/1535343239580.png)
